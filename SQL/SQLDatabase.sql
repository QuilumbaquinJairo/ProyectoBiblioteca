...
-- Tabla de Art�culos (requiere para facturaci�n)
...
-- Tabla Asientos Contables Autom�ticos
CREATE TABLE AsientoContable (
    IdAsientoContable UNIQUEIDENTIFIER DEFAULT NEWID() PRIMARY KEY,
    Fecha DATE NOT NULL,
    TipoOperacion NVARCHAR(50) NOT NULL, -- Ej: 'Factura', 'N�mina'
